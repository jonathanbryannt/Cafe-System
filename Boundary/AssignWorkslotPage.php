        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function showWorkslotDetails(event) {                        
                Swal.fire({
                    ...
                    confirmButtonText: `Assign to Staff`,                    
                    ...
                    if(result.isConfirmed) {
                        confirmAssign(event.groupId);
                    }
                });
            };

            function confirmAssign(workslotId) {
                Swal.fire({
                title: "Confirm Assignment",
                text: "Are you sure you want to assign this workslot?",
                icon: "warning",
                showCancelButton: true,
                confirmButtonColor: "#d33",
                cancelButtonColor: "#3085d6",
                confirmButtonText: "Yes, assign workslot!",
                }).then((result) => {
                    if (result.isConfirmed) {                
                        window.location.href = "ChooseStaffToAssignPage.php?id=" + workslotId;
                    } 
                });
            };
