                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="ViewUsersPage.php">View Users</a>
                            <a class="nav-link" href="CreateUsersPage.php">Create New Users</a>
                        </nav>
                    </div>  
                    ...
                    <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="ViewRolesPage.php">View Roles</a>
                            <a class="nav-link" href="CreateRolesPage.php">Create New Roles</a>
                        </nav>
                    </div>                
                </div>
            </div>
