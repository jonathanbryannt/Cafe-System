                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="ViewUserPage.php">View Users</a>
                            <a class="nav-link" href="CreateUserPage.php">Create New Users</a>
                        </nav>
                    </div>  
                    ...
                    <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="ViewProfilePage.php">View Profiles</a>
                            <a class="nav-link" href="CreateProfilePage.php">Create New Profiles</a>
                        </nav>
                    </div>                
                </div>
            </div>
