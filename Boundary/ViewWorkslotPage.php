...
while($workslot = $allWorkslots->fetch_assoc()) {
    $events[] = [
        ...
        'chef_max_qty' => $workslot['chef_max_qty'],
        'cashier_max_qty' => $workslot['cashier_max_qty'],
        'waiter_max_qty' => $workslot['waiter_max_qty'],
        'chef_current_qty' => $workslot['chef_current_qty'],
        'cashier_current_qty' => $workslot['cashier_current_qty'],
        'waiter_current_qty' => $workslot['waiter_current_qty'],
            ...
            function showWorkslotDetails(event) {                        
                Swal.fire({
                    ...
                    html: `
                        ...
                        <p><strong>Chef(s):</strong> ${event.extendedProps.chef_current_qty}/${event.extendedProps.chef_max_qty}</p>
                        <p><strong>Cashier(s):</strong> ${event.extendedProps.cashier_current_qty}/${event.extendedProps.cashier_max_qty}</p>
                        <p><strong>Waiter(s):</strong> ${event.extendedProps.waiter_current_qty}/${event.extendedProps.waiter_max_qty}</p>
